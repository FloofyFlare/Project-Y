      ...
      <div class="flex-1 w-full pt-12 md:pt-0 sm:flex md:mt-0">
        <div class="dropdown w-full">
          <div
            tabindex="0"
            role="button"
            class="flex bg-info btn text-neutral md:m-1"
          >
            Categories
          </div>
          <ul
          ...
          >
            <li><a class="font-bold" @click="setBrand('Apple')">Apple</a></li>
            <li>
              <a class="font-bold" @click="setBrand('Samsung')">Samsung</a>
            </li>
            <li class="hidden">
              <a class="font-bold" @click="setBrand('Google')">Google</a>
            </li>
            <li>
              <a class="font-bold" @click="clearFilter(Null)">All Tech</a>
            </li>
            <li class="hidden">
      ...
      <div class="flex-1 justify-end">
        <div class="pt-12 md:pt-0">
          <div class="mt-">
            ...
            <NuxtLink
              v-if="!loggedIn"
              class="m-4 mt-4 w-32 btn bg-primary mt-24"
              to="Login"
            >
