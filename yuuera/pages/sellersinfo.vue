    ...
    <body class="bg-base-100 md:w-screen">
        ...
        <section class="rounded-md bg-info">
            <div class="flex h-screen w-full bf-info">
                ...
                <div class="mt-24 flex justify-center md:justify-center">
                        <div class="lg:pt-24 rounded-2xl">
                        <p class="text-secondary text-center leading-loose tracking-widest text-4xl md:text-4xl p-4 pt-0 font-semibold">
                          Enter Your information Below
                        </p>
                        <div class="form-control mt- w-full max-w-xs">
                        <label class="label">
