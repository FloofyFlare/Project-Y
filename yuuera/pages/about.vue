<template>
    ...
    <head>
      ...
      <header class="bg-neutral text-base-200">
          <div class="navbar flex-1">
            <NuxtLink class="btn btn-ghost normal-case text-xl" to="/">Yuuera</NuxtLink>
          </div>
      ...
      <body>
        ...
        <div class="-base-100 mb-96">
        <h1 class="text-info font-bold text-xl ">Mission Statement</h1>
        <p class="text-base-100">Providing utility for the future of web 3.0</p>
        
        <h1 class="text-info font-bold text-xl">About us</h1>
...
<footer class="footer px-10 py-4 border-t bg-natural text-base-content border-base-300">
  <div class="items-center grid-flow-col text-accent">
  ...
  <div class="md:place-self-center md:justify-self-end">
    <div class="grid grid-flow-col gap-4 text-accent">
      <p>Our company Email (plus logo)</p>
