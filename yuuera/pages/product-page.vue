  ...
  <body class="bg-info md:w-full m-h-screen sm:h-screen">
    <main class="h-full">
      <section class="rounded-xl h-full pt-10">
        <span id="next"></span>
        <div
          class="mb-10 flex flex-wrap justify-end pl-4 pr-4 pt-40 sm:pt-24 h-full sm:h-auto"
        >
          <img
          ...
          <div class="h-full w-2/3 h-60 mt-12 rounded-3xl ml-24">
            ...
            <div>
              <p
                class="w-full text-left pt-6 text-neutral leading-loose text-md md:text-2xl"
              ></p>
            </div>
            <div class="flex">
