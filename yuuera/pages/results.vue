<template>
  ...
  <body class="bg-info md:w-full min-h-screen">
    <main class="min-h-screen">
          ...
          <div class="hero-content text-center text-neutral-content">
            <div class="max-w-4xl sm:text-left">
              ...
              <div class="text-left justify left">
                <p class="mt-6 text-3xl text-base-100">By Brand</p>
                <div class="dropdown w-full">
                  <div
                    tabindex="0"
                    role="button"
                    class="flex bg-info btn text-neutral m-1"
                  >
                    Categories
                  </div>
                  <ul
                    tabindex="0"
                    class="dropdown-content z-[1] menu p-2 bg-primary shadow bg-base-100 rounded-box w-full"
                  >
                    <li>
                      <a class="font-bold" @click.prevent="setBrand('Apple')"
                        >Apple</a
                      >
                    </li>
                    <li>
                      <a class="font-bold" @click="setBrand('Samsung')"
                        >Samsung</a
                      >
                    </li>
                    <li class="hidden">
                      <a class="font-bold" @click="setBrand('Google')"
                        >Google</a
                      >
                    </li>
                    <li>
                      <a class="font-bold" @click="clearFilter(Null)"
                        >All Tech</a
                      >
                    </li>
                    <li class="hidden">
                      <a class="font-bold" @click="setBrand('Merch')">Merch</a>
                    </li>
                  </ul>
                </div>
                <div>
                  <button
                    class="flex-1 btn btn-outline btn-primary btn-md"
                    @click="highLow('asc')"
                  >
                    Low to High
                  </button>
      ...
      <section id="products" class="pt-24 h-full">
        <div class="p-24">
          ...
          <div
            v-for="item in items"
            :key="item.id"
            class="pb-10 sm:flex w-screen sm:w-full justify-center"
          >
            <NuxtLink
              class="card lg:card-side border-black border-2 bg-base-100 w-1/2 shadow-xl"
            >
              <figure>
                <nuxt-img
                  :alt="`a prouct image`"
              ...
              <div class="card-body">
                ...
                <div class="card-actions justify-end">
                  <button class="btn btn-primary" @click="searchProduct(item)">
                    ${{ item.price }} DJED
                  </button>
                </div>
              </div>
