  ...
  <head>
    ...
    <header class="bg-neutral text-base-200">
      <div class="navbar flex-1">
        <a class="btn btn-ghost normal-case text-xl">Yuuera</a>
        <NuxtLink class="btn btn-ghost normal-case text-xl" to="/about">About us</NuxtLink>
      </div>
      
    </header>
  <body class="text-accent mb-96">
    <EmailSignUp/>
