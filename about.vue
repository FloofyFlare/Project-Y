...
<head>
  ...
  <header class="bg-base-300 text-success">
      <div class="navbar flex-1">
        <a class="btn btn-ghost normal-case text-xl" href="/">Yuuera</a>
      </div>
      
    </header>
  <body>

    <h1 class="">Mission Statement</h1>
    <p>Providing utility for the future of web 3.0</p>
...
<footer class="footer p-10 bg-neutral text-neutral-content bg-success ">
  <div>
    ...
    <p>(for future referce) copyright notice link to the privacy policy Sitemap company email/contact info: </p>
  </div> 
  <div>
